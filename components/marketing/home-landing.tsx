...
export function HomeLanding() {
  return (
    <main className="min-h-screen bg-background text-foreground">
          ...
          <Card className="relative w-sm rounded-3xl border border-border/50 bg-card/95 shadow-xl transition-transform duration-500 md:w-lg sm:rotate-3 sm:bg-card/80 sm:shadow-2xl sm:backdrop-blur-xl sm:hover:rotate-0">
            <CardHeader className="pb-2">
              <CardTitle className="flex justify-between items-center text-xs font-medium text-muted-foreground">
                <span className="uppercase tracking-wide">Active Portfolio</span>
      ...
      <section
        id="precision-tools"
        className="border-y border-border/70 bg-muted/30 [contain-intrinsic-size:1px_1200px] [content-visibility:auto]"
      >
      ...
      <section
        id="pricing"
        className="max-w-6xl mx-auto px-6 py-24 [contain-intrinsic-size:1px_1200px] [content-visibility:auto]"
      >
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          ...
          <Card className="rounded-3xl border-2 border-accent bg-accent/5 shadow-xl p-6 relative">
            ...
            <CardContent className="p-0 mt-4 space-y-5">
              ...
              <Button
                className="w-full rounded-xl bg-accent text-accent-foreground hover:opacity-90"
                asChild
              >
                <Link href="/sign-in">Go Basic</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-3xl border bg-card shadow-sm p-6">
            ...
            <CardContent className="p-0 mt-4 space-y-5">
              ...
              <Button className="w-full rounded-xl" asChild>
                <Link href="/sign-up">Contact Team</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="max-w-xl mx-auto space-y-8">
          <div>
            ...
            <p className="mt-4 text-sm text-accent-foreground/80 leading-relaxed">
              ...
              retail trader lacks an architectural approach to markets. We
              don&apos;t just provide tips; we provide a framework.
            </p>
          </div>
