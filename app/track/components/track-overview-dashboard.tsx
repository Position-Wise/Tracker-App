...
import { AccountsOverviewPanel } from "@track/components/accounts-overview-panel"
import { ExpenseActivityBoard } from "@track/components/expense-activity-board"
import { SpendByCategoryList } from "@track/components/spend-by-category-list"
        ...
        <section className="track-panel flex flex-col p-5 sm:p-6">
          ...
          <div className="mt-8">
            <SpendByCategoryList
              ...
              currency={currency}
              href={`/app/expenses?month=${monthKey}`}
            />
          </div>
          ...
          <Link
            href={`/app/analytics?month=${monthKey}`}
